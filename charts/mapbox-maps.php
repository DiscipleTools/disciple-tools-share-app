...
class DT_Metrics_Share_App_Maps extends DT_Metrics_Chart_Base
{

    //slug and title of the top menu folder
    public $base_slug = 'share_app'; // lowercase
    public $base_title = 'Share App';
    public $post_type = 'contacts';

    public $title = 'Map';
    public $slug = 'share_app_maps'; // lowercase
    ...
    public $namespace = 'dt-metrics/share_app_maps';
    public $base_filter = [];
    ...
    public function __construct() {
        ...
        $this->base_title = __( 'Share App', 'disciple_tools' );
    ...
    public function cluster_geojson( WP_REST_Request $request ) {
        ...
        return Disciple_Tools_Mapping_Queries::cluster_reports_geojson( $post_type, $query );
    }
